...
;  This assembly language program provides a count
;  of the Perfect numbers, Abundant numbers,
;  and Deficient numbers between 2 and a user
;  provided limit.
